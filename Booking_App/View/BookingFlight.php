...
<main>
    ...
    <div class="recommendation-section">
        ...
        <div class="recommendation-container">
            <a href="FlightDetails.php?departure_city=Penang&destination_city=Kuala+Lumpur" class="recommendation">
                ...
                <div class="info-tag">
                    <div class="flight-info-container">
                        ...
                        <div class="flight-price">Starting From RM99</div>
                    </div>
                </div>
            </a>
            <a href="FlightDetails.php?departure_city=Kuala+Lumpur&destination_city=Langkawi" class="recommendation">
                <img src="../../image/flight2.jpg" alt="Flight 2">
                <div class="info-tag">
                    <div class="flight-info-container">
                        <div class="flight-icon"><i class="fas fa-plane"></i></div>
                        <div class="flight-info">Kuala Lumpur → Langkawi</div>
                        <div class="flight-price">Starting From RM188</div>
                    </div>
                </div>
            </a>
            <a href="FlightDetails.php?departure_city=Kuala+Lumpur&destination_city=Kota+Kinabalu" class="recommendation">
                <img src="../../image/flight3.jpg" alt="Flight 3">
                <div class="info-tag">
                    <div class="flight-info-container">
                        <div class="flight-icon"><i class="fas fa-plane"></i></div>
                        <div class="flight-info">Kuala Lumpur → Kota Kinabalu</div>
                        <div class="flight-price">Starting From RM388</div>
                    </div>
                </div>
            </a>
            <a href="FlightDetails.php?departure_city=Kuching&destination_city=Penang" class="recommendation">
                <img src="../../image/flight4.jpg" alt="Flight 4">
                <div class="info-tag">
                    <div class="flight-info-container">
                        <div class="flight-icon"><i class="fas fa-plane"></i></div>
                        <div class="flight-info">Kuching → Penang</div>
                        <div class="flight-price">Starting From RM359</div>
                    </div>
                </div>
            </a>
            <a href="FlightDetails.php?departure_city=Kuching&destination_city=Sandakan" class="recommendation">
                <img src="../../image/flight5.jpg" alt="Flight 5">
                <div class="info-tag">
                    <div class="flight-info-container">
                        <div class="flight-icon"><i class="fas fa-plane"></i></div>
                        <div class="flight-info">Kuching → Sandakan</div>
                        <div class="flight-price">Starting From RM279</div>
                    </div>
                </div>
            </a>
            <a href="FlightDetails.php?departure_city=Kota+Kinabalu&destination_city=Kuching" class="recommendation">
                <img src="../../image/flight6.jpg" alt="Flight 6">
                <div class="info-tag">
                    <div class="flight-info-container">
                        <div class="flight-icon"><i class="fas fa-plane"></i></div>
                        <div class="flight-info">Kota Kinabalu → Kuching</div>
                        <div class="flight-price">Starting From RM199</div>
                    </div>
                </div>
            </a>
        </div>
